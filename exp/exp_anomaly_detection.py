...
class Exp_Anomaly_Detection(Exp_Basic):
    ...
    def finetune(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            if vali_loss < min_best_loss:
                min_best_loss = vali_loss
                torch.save(self.model.state_dict(), path + '/' + 'checkpoint_or' + '.pth')
        ...
        self.model.load_state_dict(torch.load(path + '/' + 'checkpoint_or' + '.pth'))
        return self.model
    ...
    def test(self, setting, test=0):
        ...
        filename = path + '/ucr768_' + self.args.model + '.npy'
        ...
        os.remove(path + '/' + 'checkpoint_or' + '.pth')
